...
public class GroupParticipantsRemoveActivity extends ActionBarActivity implements
		OnRemoveMUCListener {

	public static ListView listView;
	public String TAG = "GroupParticipantsRemoveActivity";
	...
	protected void handleSelection() {
		...
		if (totalSelectedModel.size() >= 1) {
			...
			new RemovePeopleFromGroup(GroupParticipantsRemoveActivity.this, groupId,
	...
	public void onRemoveMUCSuccess(ArrayList<RosterModel> removedFriendsList) {
		...
		if (totalUnSelectedModel.size() >= 1) {
			...
			if (GroupsModel.deleteGroup(groupId)) {
				...
				Intent i = new Intent(GroupParticipantsRemoveActivity.this,
						MainActivity.class);
