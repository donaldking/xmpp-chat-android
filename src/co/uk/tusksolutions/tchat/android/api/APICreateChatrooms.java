...
public class APICreateChatrooms {
	...
	public void doPostChatroom(String chatroom_id, String chatroom_name,
			String chatroom_owner, String start_timestamp,String end_timestamp,String status,String max_guest,String created_at)
	{
		if(mTask!=null)
		{
			return;
	...
	private class AsyncApiPostChatroom extends AsyncTask<Void, Void, Boolean> {
		...
		protected Boolean doInBackground(Void... params) {
			...
			try {
				...
				postParams
						.add(new BasicNameValuePair("room_name", chatroom_name));
				postParams
						.add(new BasicNameValuePair("room_owner", chatroom_owner));
				postParams.add(new BasicNameValuePair("start_timestamp", start_timestamp));
				postParams.add(new BasicNameValuePair("end_timestamp", start_timestamp));
